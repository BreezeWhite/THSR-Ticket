...
def test_outbound_date(val):
    with pytest.raises(ValueError):
        book.outbound_date = val
    book.outbound_date = "2020/02/28"
    assert book.outbound_date == "2020/02/28"
...
def test_inbound_date(val):
    with pytest.raises(ValueError):
        book.inbound_date = val
    book.inbound_date = "2020/02/28"
    assert book.inbound_date == "2020/02/28"
...
def test_get_params():
    ...
    expected = {
        ...
        "bookingMethod": 0,
        "toTimeInputField": "2020/02/28",
        "toTimeTable": "530P",
        "toTrainIDInputField": 0,
        "backTimeInputField": "2020/02/28",
        "backTimeTable": "",
